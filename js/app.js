...
botonConfirmar.addEventListener("click", () =>{
  ...
  if (carrito == 0) {
    ...
    msjCompra(`¡Gracias por tu compra! El total de tu boleta es: ${totalCarrito.innerHTML}`,
     "Completa el formulario para recibir las mejores ofertas.")
  }
  carrito.length = 0;
